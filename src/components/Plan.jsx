  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4' >
        ...
        <div className='flex flex-col h-full justify-center'>
            ...
            <p className='text-2xl py-6'>We are here to help you to book some best beaches in the globe.</p>
            <p className='pb-6'>Beaches include Copacabana ,Rio de Janeiro, Santa Monica Beach, California ,South Beach, Miami, Waikiki, Honolulu, Hawaii and many more...</p>
            <div>
                <button className='border-black mr-4 hover:shadow-xl'>Load More</button>
                <button className='border-black bg-black text-white mr-4 hover:shadow-xl'>Book Your Trip</button>
            </div>
        </div>
